...
--	leaveGroupButton:SetPoint("LEFT", LootsButton, "RIGHT", 5, 0) -- Positioned next to Gear Score button
	leaveGroupButton:SetPoint("LEFT", repairButton, "RIGHT", 5, 0) -- Positioned next to Gear Score button	
