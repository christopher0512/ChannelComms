...
local summonsButton = createPopupButton("SummonsButton", "Summons", "TOP", -26, "Thank you for the Summons") -- Adjusted spacing
local portalButton = createPopupButton("PortalButton", "Portal", "TOP", -48, "Thank you for the Portal") -- Adjusted spacing
local cookiesButton = createPopupButton("CookiesButton", "Cookies", "TOP", -70, "Thank you for the Cookies") -- Adjusted spacing
local tableButton = createPopupButton("TableButton", "Table", "TOP", -92, "Thank you for the Mage Table") -- Adjusted spacing
local foodButton = createPopupButton("FoodButton", "Food", "TOP", -114, "Thank you for the Food") -- Adjusted spacing
local foodButton = createPopupButton("HealsButton", "Heals", "TOP", -136, "Thank you for the Awesome Healing!") -- Adjusted spacing
local foodButton = createPopupButton("RezButton", "Rez", "TOP", -158, "Thank you for the Rez") -- Adjusted spacing
local foodButton = createPopupButton("RepairsButton", "Repairs", "TOP", -180, "Thank you for the Repairs") -- Adjusted spacing
